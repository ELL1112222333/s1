...
public class IPLimitAspect {
    ...
    @Pointcut("@annotation(org.example.aopannotation.IPLimit)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws NoSuchMethodException {
        ...
        //获取注解信息
        IPLimit annotation = currentMethod.getAnnotation(IPLimit.class);
        ...
        try {
            if (rateLimiter.tryAcquire()) {
                ...
                //拒绝了请求（服务降级）
                String result = objectMapper.writeValueAsString(Result.error("500", "系统繁忙！"));
